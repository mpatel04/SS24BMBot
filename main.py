...
async def send_start_message(chat_id: int, context: CallbackContext) -> int:
    keyboard = [
        ...
        [InlineKeyboardButton("Breakout Locations", callback_data='group_act')],
...
async def button(update: Update, context: CallbackContext) -> None:
    ...
    if query.data == 'schedule':
        media = [
                   InputMediaPhoto(open(f'Assets/day3_1schedule.png', 'rb')),
                   InputMediaPhoto(open('Assets/day3_2schedule.png', 'rb'))
                ]
        ...
        media = [InputMediaPhoto(open(f'Assets/Program4.jpg', 'rb'))]
        caption = "Program 4 Seating"
    ...
    elif query.data == 'group_act':
        media = [InputMediaPhoto(open(f'Assets/group_activity.jpg', 'rb'))]
        caption = "Breakout Locations"
        ...
        message = "*Medical Emergency Contact:*\nPrimary Contact: Dr\. Kirtan\nPhone Number: 732\-983\-1816\n\nSecondary Contact: Ravibhai\nPhone Number: 240\-422\-3005\n\n*Emergency Security Number:*\nPhone Number: 609\-666\-9063"
